        ...
        <form [formGroup]="form" (ngSubmit)="onSubmit()" class="mt-5 space-y-3.5">
          ...
          <div>
            ...
            <div class="relative group">
              <app-icon name="projects" className="w-4 h-4 absolute left-3 top-1/2 -translate-y-1/2 text-ink3 group-focus-within:text-cyan3 transition-colors pointer-events-none"></app-icon>
              <input
                type="text"
