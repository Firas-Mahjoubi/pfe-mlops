...
GET  & \texttt{/monitoring/project/\{id\}/ serving} & Serving KPIs: volume, error rate, latency, timeline, traffic by origin, per-deployment breakdown\\ \hline
GET  & \texttt{/deployments/\{id\}/metrics} & Live per-deployment \gls{cpu} and memory usage\\ \hline
