...
training on a Kubernetes cluster with automatic experiment tracking, register and
promote model versions, deploy them as live prediction services, and expose them
to external applications through secured public API keys, while an administrator
oversees users and resources. The system is built with FastAPI, Angular, Kubeflow
...
Scrum method over four sprints spanning six months.
...
exp\'eriences, d'enregistrer et de promouvoir des versions de mod\`eles, de les
d\'eployer comme services de pr\'ediction, et de les exposer \`a des applications
externes via des cl\'es API publiques s\'ecuris\'ees, tandis qu'un administrateur
supervise les utilisateurs et les ressources. Le syst\`eme repose sur FastAPI,
...
\'et\'e conduit avec la m\'ethode Scrum en quatre sprints sur six mois.
